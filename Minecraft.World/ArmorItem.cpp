...
const int _ArmorMaterial::netheriteArray[] = {3, 8, 6, 3};
...
const _ArmorMaterial *_ArmorMaterial::NETHERRITE = new _ArmorMaterial(37, _ArmorMaterial::netheriteArray, 15);
