...
class Item : public enable_shared_from_this<Item>
{
  ...
  public:
    ...
    static const int helmet_netherite_Id = 444;
    static const int chestplate_netherite_Id = 445;
    static const int leggings_netherite_Id = 446;
    static const int boots_netherite_Id = 447;
