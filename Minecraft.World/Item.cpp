...
void Item::staticCtor()
{
    ...
    Item::helmet_netherite = static_cast<ArmorItem *>((new ArmorItem(74, ArmorItem::ArmorMaterial::NETHERRITE, 5, ArmorItem::SLOT_HEAD))->setBaseItemTypeAndMaterial(eBaseItemType_helmet, eMaterial_netherite)->setIconName(L"helmetNetherite")->setDescriptionId(IDS_ITEM_HELMET_NETHERITE)->setUseDescriptionId(IDS_DESC_HELMET_NETHERITE));
    Item::chestplate_netherite = static_cast<ArmorItem *>((new ArmorItem(75, ArmorItem::ArmorMaterial::NETHERRITE, 5, ArmorItem::SLOT_TORSO))->setBaseItemTypeAndMaterial(eBaseItemType_chestplate, eMaterial_netherite)->setIconName(L"chestplateNetherite")->setDescriptionId(IDS_ITEM_CHESTPLATE_NETHERITE)->setUseDescriptionId(IDS_DESC_CHESTPLATE_NETHERITE));
    Item::leggings_netherite = static_cast<ArmorItem *>((new ArmorItem(76, ArmorItem::ArmorMaterial::NETHERRITE, 5, ArmorItem::SLOT_LEGS))->setBaseItemTypeAndMaterial(eBaseItemType_leggings, eMaterial_netherite)->setIconName(L"leggingsNetherite")->setDescriptionId(IDS_ITEM_LEGGINGS_NETHERITE)->setUseDescriptionId(IDS_DESC_LEGGINGS_NETHERITE));
    Item::boots_netherite = static_cast<ArmorItem *>((new ArmorItem(77, ArmorItem::ArmorMaterial::NETHERRITE, 5, ArmorItem::SLOT_FEET))->setBaseItemTypeAndMaterial(eBaseItemType_boots, eMaterial_netherite)->setIconName(L"bootsNetherite")->setDescriptionId(IDS_ITEM_BOOTS_NETHERITE)->setUseDescriptionId(IDS_DESC_BOOTS_NETHERITE));
