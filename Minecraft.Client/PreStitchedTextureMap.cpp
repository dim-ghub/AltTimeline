...
void PreStitchedTextureMap::loadUVs()
{
    ...
    if (iconType != Icon::TYPE_TERRAIN)
    {
        ...
        ADD_ICON(0, 5, L"flint")
        ADD_ICON(0, 6, L"coal")
        ADD_ICON(0, 7, L"string")
        ADD_ICON(0, 8, L"seeds")
        ADD_ICON(0, 9, L"apple")
        ADD_ICON(0, 10, L"appleGold")
        ADD_ICON(0, 11, L"egg")
        ADD_ICON(0, 12, L"sugar")
        ADD_ICON(0, 13, L"snowball")
        ADD_ICON(0, 14, L"slot_empty_helmet")
        ADD_ICON(0, 15, L"slot_empty_chestplate")

        ADD_ICON(1, 14, L"slot_empty_leggings")
        ADD_ICON(1, 15, L"slot_empty_boots")

        ADD_ICON(9, 0, L"helmetNetherite")
        ADD_ICON(10, 0, L"chestplateNetherite")
        ADD_ICON(11, 0, L"leggingsNetherite")
        ADD_ICON(12, 0, L"bootsNetherite")
        ...
        ADD_ICON(2, 5, L"quiver")
        ADD_ICON(2, 6, L"ingotGold")
        ADD_ICON(2, 7, L"sulphur")
        ADD_ICON(2, 8, L"bread")
        ADD_ICON(2, 9, L"sign")
        ADD_ICON(2, 10, L"leggingsNetherite")
        ...
        ADD_ICON(3, 5, L"compass")
        ADD_ICON(3, 6, L"diamond")
        ADD_ICON(3, 7, L"redstone")
        ADD_ICON(3, 8, L"clay")
        ADD_ICON(3, 9, L"paper")
        ADD_ICON(3, 10, L"bootsNetherite")
